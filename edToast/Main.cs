        ...
        private void btnOrder_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    try
                    {
                        order.Insert(tbNoPesanan.Text, tbNama.Text, Convert.ToDecimal(tbPesan1.Text), Convert.ToDecimal(tbPesan2.Text), Convert.ToDecimal(tbPesan3.Text), Convert.ToDecimal(tbPesan4.Text), tbTotal.Text);
